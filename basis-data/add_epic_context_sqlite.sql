-- Add Epic Context Table for JIRA Integration (SQLite Version)
-- This table stores Epic context for user sessions

-- =====================================================
-- JIRA Connections Table (create first)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS scenarios (
  ...
  feature_name TEXT,
  description TEXT,
  scenarios_json TEXT NOT NULL, -- JSON string
  template_id TEXT,
...
-- =====================================================
-- Add JIRA columns to scenarios table
-- =====================================================

-- Add JIRA-related columns to scenarios table if they don't exist
ALTER TABLE scenarios ADD COLUMN jira_epic_id TEXT;
ALTER TABLE scenarios ADD COLUMN jira_user_story_id TEXT;
ALTER TABLE scenarios ADD COLUMN jira_subtask_ids TEXT; -- JSON array as string
...
-- Create indexes for JIRA fields in scenarios
