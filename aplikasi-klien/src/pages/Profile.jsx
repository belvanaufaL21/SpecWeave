        ...
        {deleteConfirmation.isOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-[#0a0a0f] border border-white/10 rounded-2xl shadow-2xl w-full max-w-md p-6"
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white/60">
                    Are you sure you want to delete "{deleteConfirmation.chatTitle}"? This action cannot be undone.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  onClick={cancelDeleteChat}
                  className="flex-1 px-4 py-3 bg-transparent hover:bg-white/[0.03] border border-white/10 rounded-xl text-white/60 hover:text-white transition-all font-medium"
                >
                  Cancel
                </button>
                <button
                  onClick={confirmDeleteChat}
                  className="flex-1 px-4 py-3 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-xl text-red-400 hover:text-red-300 transition-all font-medium"
                >
                  Delete
                </button>
              </div>
