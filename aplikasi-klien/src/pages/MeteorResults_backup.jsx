...
const MeteorResults = () => {
  ...
  const handleExportResults = () => {
    ...
    link.href = url;
    link.download = `hasil-meteor-test-${testResult.messageId}-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg text-sm hover:from-purple-600 hover:to-pink-600 transition-all flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="space-y-4">
                  ...
                  <WordAnalysis 
                    ...
                    matches={['admin', 'mencoba', 'mengubah', 'hak', 'akses', 'pengguna', 'token', 'otentikasi']}
                    type="GIVEN"
                  />
                  ...
                  <WordAnalysis 
                    ...
                    matches={['admin', 'menekan', 'tombol', 'simpan']}
                    type="WHEN"
                  />
                  ...
                  <WordAnalysis 
                    ...
                    matches={['sistem', 'menolak', 'perubahan', 'menampilkan', 'pesan', 'error', 'admin', 'tidak', 'valid', 'login', 'hak', 'akses']}
                    type="THEN"
                  />
                  ...
                  <div className="bg-gray-900/30 rounded-lg p-4 border border-gray-600/30">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-blue-400 font-medium">12 kata</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-300">Kata referensi (WHEN):</span>
                        <span className="text-blue-400 font-medium">5 kata</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-300">Kata referensi (THEN):</span>
                        <span className="text-blue-400 font-medium">20 kata</span>
                      </div>
                      <div className="border-t border-gray-600/30 pt-2 mt-2">
                        <div className="flex justify-between">
                          <span className="text-gray-300">Total kata referensi:</span>
                          <span className="text-blue-400">37 kata</span>
                        </div>
                        <div className="flex justify-between font-semibold">
                          <span className="text-white">Kata yang tertangkap:</span>
                          <span className="text-green-400">19 kata</span>
                        </div>
                        <div className="flex justify-between font-bold text-lg mt-2">
                          <span className="text-white">Recall:</span>
                          <span className="text-green-400">19/37 = {(testResult.recall * 100).toFixed(1)}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
