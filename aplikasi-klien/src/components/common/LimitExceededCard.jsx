...
const LimitExceededCard = ({ error, onSwitchModel, onRetry }) => {
  ...
  return (
    <div
      ...
      style={{
        borderColor: 'rgba(194, 122, 255, 0.15)',
      ...
      <div className="px-4 py-3 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.05)' }}>
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ color: isReady ? '#C27AFF' : '#fbbf24' }}
          >
            {timeLeft}
          </span>
        </div>
          ...
          <div className="space-y-1.5">
            {alternatives.slice(0, 4).map((alt) => (
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = 'rgba(194, 122, 255, 0.3)';
                  e.currentTarget.style.backgroundColor = 'rgba(194, 122, 255, 0.05)';
                }}
                onMouseLeave={(e) => {
