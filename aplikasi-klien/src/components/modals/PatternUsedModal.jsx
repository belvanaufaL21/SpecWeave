          ...
          <div className="relative z-10 flex flex-col max-h-[85vh]">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="space-y-6">
                {/* Method Info */}
                <div className="bg-[#120C18] border border-[#2C1A43] rounded-2xl p-4">
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                    <div className="flex-1">
                      <div className="text-xs font-semibold text-purple-400 mb-1">Prompting Method</div>
                      <div className="text-sm font-semibold text-white capitalize">{promptingMethod} Prompting</div>
                    </div>
                    <div className="px-3 py-1.5 bg-transparent border border-[#2C1A43] rounded-lg">
                ...
                {references.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400">No references were used in this generation</p>
                  </div>
                )}
              </div>
            </div>
